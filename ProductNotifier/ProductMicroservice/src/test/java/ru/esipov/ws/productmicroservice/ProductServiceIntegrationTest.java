package ru.esipov.ws.productmicroservice;
...
import ru.esipov.ws.productmicroservice.service.ProductService;
...
public class ProductServiceIntegrationTest {
    ...
    @BeforeAll
    void setUp() {
        DefaultKafkaConsumerFactory<String, Object> consumerFactory = new DefaultKafkaConsumerFactory<>(getConcumerProperties());
    ...
    @Test
    void testCreateProduct_whenGivenValidProductDetails_thenSuccessfullySendsKafkaMessage() throws ExecutionException, InterruptedException {
        //Arrange
    ...
    private Map<String, Object> getConcumerProperties() {
        return Map.of(
